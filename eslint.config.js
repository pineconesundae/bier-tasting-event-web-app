...
export default [
  ...
  {
    files: ['src/**/*.{js,jsx}'],
    languageOptions: { ecmaVersion: 2022, sourceType: 'module', parserOptions: { ecmaFeatures: { jsx: true } }, globals: { document: 'readonly', fetch: 'readonly', window: 'readonly', alert: 'readonly', confirm: 'readonly' } },
